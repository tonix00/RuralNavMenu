			...
			<div class="container">
				<div class="columns">
					<div class="column is-12">
						...
						<form:form enctype="multipart/form-data" action="UploadWithPreviewForm.htm" method="post" commandName="${model.commandName}" id="form-id">
							${model.uploadWithPreviewFormTags}
						</form:form>
