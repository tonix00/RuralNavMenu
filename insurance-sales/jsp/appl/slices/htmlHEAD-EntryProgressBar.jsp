...
<html lang="en">
	<head>
		...
		<!-- jquery modal -->
		<link href="${thirdpartyjsdir}jquery-modal/jquery.modal.css" rel="stylesheet" />
		...
		<!-- fancybox -->
		<link href="${thirdpartyjsdir}fancybox/3.3.5/jquery.fancybox.min.css" rel="stylesheet" />
		...
		<link href="${cssdir}bulma-divider.css" rel="stylesheet" />
		...
		<!-- ProgressBar -->
		<script src="${jsdir}progressbar.js"></script>
			
		<!-- modernizr -->
		<script src="${thirdpartyjsdir}modernizr/modernizr.custom.29473.js"></script>
		
		<!-- TinyMCE -->
		<script type="text/javascript" src="${thirdpartyjsdir}tiny_mce/tiny_mce.js"></script>
		<script type="text/javascript">
			tinyMCE.init({
				...
				theme_advanced_buttons1: 
					...
					"cut,copy,paste,|bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,forecolor,backcolor"
			});
		</script>
		<!-- /TinyMCE -->
		
		<!-- moment.js -->
		<script src="${thirdpartyjsdir}momentjs/moment.min.js"></script>
